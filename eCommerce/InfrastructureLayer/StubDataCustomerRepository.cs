...
namespace eCommerce.InfrastructureLayer
{
    ...
    {
        private readonly MemoryRepository<Customer> memRepository;

        public StubDataCustomerRepository(MemoryRepository<Customer> memRepository)
        {
            this.memRepository = memRepository;

            Customer customer = Customer.Create(new Guid("5D5020DA-47DF-4C82-A722-C8DEAF06AE23"), "john", "smith", "john.smith@microsoft.com", Country.Create(new Guid("229074BD-2356-4B5A-8619-CDEBBA71CC21"), "United Kingdom"));
